...
const steps = [
  ...
  },
  {
    ...
    detail: "Neither person ever learns the other's choice unless it's mutual. The server resolves decisions privately. Without mutual Spark, raw video and audio end immediately. Safety transcript snippets and call metadata may be retained for up to 30 days for moderation review.",
  },
  {
    icon: MessageCircle,
    step: "04",
