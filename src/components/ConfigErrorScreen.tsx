...
/**
 * Fail-fast UI shown when required Supabase env vars are absent at runtime.
 * This component intentionally avoids React Router, ThemeProvider, and all
 * third-party providers so it can render even when the app is misconfigured.
 */
